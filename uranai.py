...
def myuranai(input_text):
  ...
  if 'color1' in frame and 'color2' in frame:
    ...
    if '青色' in frame['color1'] and '緑色' in frame['color2']:
      return '青色を選んだあなたは冷静で争い事が好きではない平和主義な性格です。緑色のお相手は内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。ターコイズ色。'
    ...
    if '緑色' in frame['color1'] and '黄色' in frame['color2']:
      return '緑色を選んだあなたは内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。黄色のお相手はとにかく明るくて、ユーモアがあり、知性溢れる性格です。黄緑色。'
