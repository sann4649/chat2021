...
def myuranai(input_text):
  ...
  if 'color1' in frame and 'color2' in frame:
    ...
    if '赤色' in frame['color1'] and '黄色' in frame['color2']:
      return '赤色を選んだあなたは情熱的で行動力があり、とにかく一歩前へ前進する性格です。黄色のお相手はとにかく明るくて、ユーモアがあり、知性溢れる性格です。'
    if '赤色' in frame['color1'] and '青色' in frame['color2']:
      return '赤色を選んだあなたは情熱的で行動力があり、とにかく一歩前へ前進する性格です。青色のお相手は冷静で争い事が好きではない平和主義な性格です。'
    if '赤色' in frame['color1'] and '緑色' in frame['color2']:
      return '赤色を選んだあなたは情熱的で行動力があり、とにかく一歩前へ前進する性格です。緑色のお相手は内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。'
    if '黄色' in frame['color1'] and '赤色' in frame['color2']:
      return '黄色を選んだあなたとお相手はとにかく明るくて、ユーモアがあり、知性溢れる性格です。赤色のお相手は情熱的で行動力があり、とにかく一歩前へ前進する性格です。'
    ...
    if '黄色' in frame['color1'] and '青色' in frame['color2']:
      return '黄色を選んだあなたはとにかく明るくて、ユーモアがあり、知性溢れる性格です。青色のお相手は冷静で争い事が好きではない平和主義な性格です。'
    if '黄色' in frame['color1'] and '緑色' in frame['color2']:
      return '黄色を選んだあなたはとにかく明るくて、ユーモアがあり、知性溢れる性格です。緑色のお相手は内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。'
    if '青色' in frame['color1'] and '赤色' in frame['color2']:
      return '青色を選んだあなたは冷静で争い事が好きではない平和主義な性格です。赤色のお相手は情熱的で行動力があり、とにかく一歩前へ前進する性格です。'
    if '青色' in frame['color1'] and '黄色' in frame['color2']:
      return '青色を選んだあなたは冷静で争い事が好きではない平和主義な性格です。黄色のお相手はとにかく明るくて、ユーモアがあり、知性溢れる性格です。'
    ...
    if '青色' in frame['color1'] and '緑色' in frame['color2']:
      return '青色を選んだあなたは冷静で争い事が好きではない平和主義な性格です。緑色のお相手は内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。'
    if '緑色' in frame['color1'] and '赤色' in frame['color2']:
      return '緑色を選んだあなたは内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。赤色のお相手は情熱的で行動力があり、とにかく一歩前へ前進する性格です。'
    if '緑色' in frame['color1'] and '黄色' in frame['color2']:
      return '緑色を選んだあなたは内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。黄色のお相手はとにかく明るくて、ユーモアがあり、知性溢れる性格です。'
    if '緑色' in frame['color1'] and '青色' in frame['color2']:
      return '緑色を選んだあなたは内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。青色のお相手は冷静で争い事が好きではない平和主義な性格です。'
