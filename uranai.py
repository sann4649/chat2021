...
def myuranai(input_text):
  ...
  if 'color1' in frame and 'color2' not in frame:
    ...
    return '次に先程と同様に、赤色、黄色、青色、緑色の中からお相手のイメージカラーを入力してください。(選択肢の表記と同じ様に入力してください。例えば赤色を選択した場合、赤色と入力してください。)'
  
  if 'color1' in frame and 'color2' in frame:
    
    if '赤色' in frame['color1'] and '赤色' in frame['color2']:
      return '赤色を選んだあなたとお相手は情熱的で行動力があり、とにかく一歩前へ前進する性格です。お互いに赤色のオーラで相性100％です。'
    if '赤色' in frame['color1'] and '黄色' in frame['color2']:
      return '赤色を選んだあなたは情熱的で行動力があり、とにかく一歩前へ前進する性格です。黄色のお相手はとにかく明るくて、ユーモアがあり、知性溢れる性格です。オレンジ色のオーラで相性95％です。'
    if '赤色' in frame['color1'] and '青色' in frame['color2']:
      return '赤色を選んだあなたは情熱的で行動力があり、とにかく一歩前へ前進する性格です。青色のお相手は冷静で争い事が好きではない平和主義な性格です。紫色のオーラで相性98％です。'
    if '赤色' in frame['color1'] and '緑色' in frame['color2']:
      return '赤色を選んだあなたは情熱的で行動力があり、とにかく一歩前へ前進する性格です。緑色のお相手は内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。補色の強力なオーラです。相性120％です。'
    if '黄色' in frame['color1'] and '赤色' in frame['color2']:
      return '黄色を選んだあなたはとにかく明るくて、ユーモアがあり、知性溢れる性格です。赤色のお相手は情熱的で行動力があり、とにかく一歩前へ前進する性格です。オレンジ色のオーラで相性95％です。'
    if '黄色' in frame['color1'] and '黄色' in frame['color2']:
      return '黄色を選んだあなたとお相手はとにかく明るくて、ユーモアがあり、知性溢れる性格です。お互いに黄色のオーラで相性100％です。'
    if '黄色' in frame['color1'] and '青色' in frame['color2']:
      return '黄色を選んだあなたはとにかく明るくて、ユーモアがあり、知性溢れる性格です。青色のお相手は冷静で争い事が好きではない平和主義な性格です。緑色のオーラで相性93％です。'
    if '黄色' in frame['color1'] and '緑色' in frame['color2']:
      return '黄色を選んだあなたはとにかく明るくて、ユーモアがあり、知性溢れる性格です。緑色のお相手は内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。黄緑色のオーラで相性92％です。'
    if '青色' in frame['color1'] and '赤色' in frame['color2']:
      return '青色を選んだあなたは冷静で争い事が好きではない平和主義な性格です。赤色のお相手は情熱的で行動力があり、とにかく一歩前へ前進する性格です。紫色のオーラで相性98％です。'
    if '青色' in frame['color1'] and '黄色' in frame['color2']:
      return '青色を選んだあなたは冷静で争い事が好きではない平和主義な性格です。黄色のお相手はとにかく明るくて、ユーモアがあり、知性溢れる性格です。緑色のオーラで相性93％です。'
    if '青色' in frame['color1'] and '青色' in frame['color2']:
      return '青色を選んだあなたとお相手は冷静で争い事が好きではない平和主義な性格です。お互いに青色のオーラで相性100％です。'
    if '青色' in frame['color1'] and '緑色' in frame['color2']:
      return '青色を選んだあなたは冷静で争い事が好きではない平和主義な性格です。緑色のお相手は内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。ターコイズ色のオーラで相性110％です。'
    if '緑色' in frame['color1'] and '赤色' in frame['color2']:
      return '緑色を選んだあなたは内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。赤色のお相手は情熱的で行動力があり、とにかく一歩前へ前進する性格です。補色の強力なオーラです。相性120％です。'
    if '緑色' in frame['color1'] and '黄色' in frame['color2']:
      return '緑色を選んだあなたは内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。黄色のお相手はとにかく明るくて、ユーモアがあり、知性溢れる性格です。黄緑色のオーラで相性92％です。'
    if '緑色' in frame['color1'] and '青色' in frame['color2']:
      return '緑色を選んだあなたは内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。青色のお相手は冷静で争い事が好きではない平和主義な性格です。ターコイズ色のオーラで相性110％です。'
    if '緑色' in frame['color1'] and '緑色' in frame['color2']:
      return '緑色を選んだあなたとお相手は内に秘めた情熱を持ちつつ、視野を広く見ていける性格です。お互いに緑色のオーラで相性100％です。'
